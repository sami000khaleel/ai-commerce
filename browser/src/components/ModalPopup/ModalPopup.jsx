...
console.log(modalState.hideFlag)
  ...
  return (
    <article
      ...
      } rounded-2xl overflow-hidden bg-white shadow-2xl mt-3  flex flex-col items-center gap-6 justify-start max-w-[250px] min-w-[200px]   p-7    text-red-600 z-50 absolute top-0 left-1/2 -translate-x-1/2`}
    >
      ...
      <span
        id="loader"
        className={`${!modalState.hideFlag?'animate-loader':''} absolute left-0 bottom-0 h-[10px] ${
          modalState?.errorFlag ? "bg-red-600" : "bg-[#25F433]"
        }
       `}
      ></span>
