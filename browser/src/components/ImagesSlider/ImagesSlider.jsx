    ...
    <span className="relative w-full h-full" id="container">
      <div className="flex w-full h-full overflow-hidden">
        ...
        aria-label="view next image"
          ...
          className="squich hover:bg-[rgba(0,0,0,0.2)] focus-visible:bg-[rgba(0,0,0,0.2)] w-[2rem] b-0 h-full  flex justify-center items-center  absolute top-1/2   -translate-y-1/2 left-0"
        >
        ...
        <button
          ...
          className=" hover:bg-[rgba(0,0,0,0.2)] focus-visible:bg-[rgba(0,0,0,0.2)] w-[2rem] b-0 h-full  flex justify-center  items-center  absolute top-1/2   -translate-y-1/2 right-0"
        >
          <span className="rounded-full bg-black h-7 aspect-square flex justify-center items-center">
